        ...
        [
            [
                InlineKeyboardButton(
                    ...
                    callback_data="subscription:change_currency",
                ),
            ],
            [
                InlineKeyboardButton(
...
def build_payment_keyboard(
    language_code: LanguageCode, payment_link: str
) -> InlineKeyboardMarkup:
    buttons = [
        [
            InlineKeyboardButton(
...
def build_cancel_subscription_keyboard(
    language_code: LanguageCode,
) -> InlineKeyboardMarkup:
    buttons = [
        [
            InlineKeyboardButton(
                ...
                callback_data="cancel_subscription:approve",
            )
        ],
        [
            InlineKeyboardButton(
                text=get_localization(language_code).ACTION_CANCEL,
                callback_data="cancel_subscription:cancel",
            )
        ],
    ]
...
def build_packages_keyboard(
    ...
    buttons.append(
        [
            InlineKeyboardButton(
                text="⬅️", callback_data=f"package:prev:{page - 1 if page != 0 else 5}"
            ),
            InlineKeyboardButton(
                text=f"{page + 1}/6", callback_data=f"package:page:{page}"
            ),
            InlineKeyboardButton(
                text="➡️", callback_data=f"package:next:{page + 1 if page != 5 else 0}"
            ),
        ]
    )
    buttons.extend(
...
def build_package_quantity_sent_keyboard(
    language_code: LanguageCode,
) -> InlineKeyboardMarkup:
    buttons = [
        [
...
def build_package_add_to_cart_selection_keyboard(
    language_code: LanguageCode,
) -> InlineKeyboardMarkup:
    buttons = [
        [
    ...
    buttons.extend(
        [
            [
                InlineKeyboardButton(
                    text=get_localization(language_code).PAYMENT_CHANGE_CURRENCY,
                    callback_data="package_cart:change_currency",
                ),
            ],
            [
                InlineKeyboardButton(
...
def build_payment_method_for_cart_keyboard(
    language_code: LanguageCode,
) -> InlineKeyboardMarkup:
    buttons = [
        [
...
def build_return_to_packages_keyboard(
    language_code: LanguageCode,
) -> InlineKeyboardMarkup:
    buttons = [
        [
