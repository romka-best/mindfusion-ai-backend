...
def build_settings_choose_model_type_keyboard(
    ...
    buttons = [
        [
            InlineKeyboardButton(
                ...
                callback_data="settings_choose_model_type:text_models",
            ),
        ],
        [
            InlineKeyboardButton(
                text=get_localization(language_code).MODELS_IMAGE,
                callback_data="settings_choose_model_type:image_models",
            ),
        ],
        [
            InlineKeyboardButton(
                text=get_localization(language_code).MODELS_MUSIC,
                callback_data="settings_choose_model_type:music_models",
            ),
        ],
        [
            InlineKeyboardButton(
                text=get_localization(language_code).MODELS_VIDEO,
                callback_data="settings_choose_model_type:video_models",
            ),
        ],
        [
            InlineKeyboardButton(
...
def build_settings_choose_text_model_keyboard(
    language_code: LanguageCode,
) -> InlineKeyboardMarkup:
    buttons = [
        [
...
def build_settings_choose_summary_model_keyboard(
    language_code: LanguageCode,
) -> InlineKeyboardMarkup:
    buttons = [
        [
...
def build_settings_choose_image_model_keyboard(
    language_code: LanguageCode,
) -> InlineKeyboardMarkup:
    buttons = [
        [
...
def build_settings_choose_music_model_keyboard(
    language_code: LanguageCode,
) -> InlineKeyboardMarkup:
    buttons = [
        [
...
def build_settings_choose_video_model_keyboard(
    language_code: LanguageCode,
) -> InlineKeyboardMarkup:
    buttons = [
        [
...
def build_settings_keyboard(
    ...
    buttons = []
    if (
        model == Model.CHAT_GPT
        or model == Model.CLAUDE
        or model == Model.GEMINI
        or model == Model.GROK
        or model == Model.DEEP_SEEK
        or model == Model.PERPLEXITY
    ):
        buttons = [
            [
                InlineKeyboardButton(
                    text=get_localization(
                        language_code
                    ).SETTINGS_SHOW_USAGE_QUOTA_IN_MESSAGES
                    + (
                        " ✅"
                        if settings[model][UserSettings.SHOW_USAGE_QUOTA]
                        else " ❌"
                    ),
            ...
            [
                InlineKeyboardButton(
                    text=get_localization(
                        language_code
                    ).SETTINGS_SHOW_THE_NAME_OF_THE_CHATS
                    + (
                        " ✅"
                        if settings[model][UserSettings.SHOW_THE_NAME_OF_THE_CHATS]
                        else " ❌"
                    ),
            ...
            [
                InlineKeyboardButton(
                    text=get_localization(
                        language_code
                    ).SETTINGS_SHOW_THE_NAME_OF_THE_ROLES
                    + (
                        " ✅"
                        if settings[model][UserSettings.SHOW_THE_NAME_OF_THE_ROLES]
                        else " ❌"
                    ),
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.FOCUS]
                        == VideoSummaryFocus.INSIGHTFUL
                        else ""
                    ),
            ...
            [
                ...
                InlineKeyboardButton(
                    text=get_localization(
                        language_code
                    ).VIDEO_SUMMARY_FOCUS_CONTROVERSIAL
                    + (
                        " ✅"
                        if settings[model][UserSettings.FOCUS]
                        == VideoSummaryFocus.CONTROVERSIAL
                        else ""
                    ),
            ...
            [
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.FORMAT]
                        == VideoSummaryFormat.LIST
                        else ""
                    ),
            ...
            [
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.AMOUNT]
                        == VideoSummaryAmount.SHORT
                        else ""
                    ),
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.SEND_TYPE] == SendType.IMAGE
                        else ""
                    ),
                ...
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.SEND_TYPE] == SendType.DOCUMENT
                        else ""
                    ),
            ...
            [
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.RESOLUTION]
                        == DALLEResolution.LOW
                        else ""
                    ),
            ...
            [
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.QUALITY]
                ...
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.QUALITY] == DALLEQuality.HD
                        else ""
                    ),
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.ASPECT_RATIO]
                        == AspectRatio.SQUARE
                        else ""
                    ),
            ...
            [
                ...
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.ASPECT_RATIO]
                        == AspectRatio.CINEMASCOPE_VERTICAL
                        else ""
                    ),
            ...
            [
                ...
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.ASPECT_RATIO]
                        == AspectRatio.CLASSIC_HORIZONTAL
                        else ""
                    ),
            ...
            [
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.VERSION] == MidjourneyVersion.V5
                        else ""
                    ),
                ...
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.VERSION] == MidjourneyVersion.V6
                        else ""
                    ),
                ...
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.VERSION] == MidjourneyVersion.V7
                        else ""
                    ),
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.SAFETY_TOLERANCE]
                        == FluxSafetyTolerance.STRICT
                        else ""
                    ),
            ...
            [
                InlineKeyboardButton(
                    text=get_localization(
                        language_code
                    ).FLUX_PERMISSIVE_SAFETY_TOLERANCE
                    + (
                        " ✅"
                        if settings[model][UserSettings.SAFETY_TOLERANCE]
                        == FluxSafetyTolerance.PERMISSIVE
                        else ""
                    ),
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.GENDER] == UserGender.MALE
                        else ""
                    ),
                ...
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.GENDER] == UserGender.FEMALE
                        else ""
                    ),
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.SEND_TYPE] == SendType.AUDIO
                        else ""
                    ),
                ...
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.SEND_TYPE] == SendType.VIDEO
                        else ""
                    ),
            ...
            [
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.VERSION] == SunoVersion.V3
                        else ""
                    ),
                ...
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.VERSION] == SunoVersion.V4
                        else ""
                    ),
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.DURATION]
                        == KlingDuration.SECONDS_5
                        else ""
                    ),
            ...
            [
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.MODE] == KlingMode.STANDARD
                        else ""
                    ),
                ...
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.MODE] == KlingMode.PRO
                        else ""
                    ),
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.QUALITY] == LumaRayQuality.SD
                        else ""
                    ),
                ...
                InlineKeyboardButton(
                    ...
                    + (
                        " ✅"
                        if settings[model][UserSettings.QUALITY] == LumaRayQuality.HD
                        else ""
                    ),
    ...
    buttons = [
        [
            InlineKeyboardButton(
                ...
                + (
                    " ✅"
                    if settings[Model.CHAT_GPT][UserSettings.TURN_ON_VOICE_MESSAGES]
                    else " ❌"
                ),
        ...
        [
            InlineKeyboardButton(
                ...
                + (
                    " ✅"
                    if settings[Model.CHAT_GPT][UserSettings.VOICE] == "alloy"
                    else ""
                ),
                callback_data="voice_messages_setting:alloy",
            ),
            InlineKeyboardButton(
                text="👕 echo"
                + (
                    " ✅"
                    if settings[Model.CHAT_GPT][UserSettings.VOICE] == "echo"
                    else ""
                ),
                callback_data="voice_messages_setting:echo",
            ),
        ],
        [
            InlineKeyboardButton(
                ...
                + (
                    " ✅"
                    if settings[Model.CHAT_GPT][UserSettings.VOICE] == "nova"
                    else ""
                ),
                callback_data="voice_messages_setting:nova",
            ),
            InlineKeyboardButton(
                text="👚 shimmer"
                + (
                    " ✅"
                    if settings[Model.CHAT_GPT][UserSettings.VOICE] == "shimmer"
                    else ""
                ),
                callback_data="voice_messages_setting:shimmer",
            ),
        ],
        [
            InlineKeyboardButton(
                ...
                + (
                    " ✅"
                    if settings[Model.CHAT_GPT][UserSettings.VOICE] == "fable"
                    else ""
                ),
                callback_data="voice_messages_setting:fable",
            ),
            InlineKeyboardButton(
                text="👕 onyx"
                + (
                    " ✅"
                    if settings[Model.CHAT_GPT][UserSettings.VOICE] == "onyx"
                    else ""
                ),
                callback_data="voice_messages_setting:onyx",
            ),
        ],
        [
            InlineKeyboardButton(
                text=get_localization(language_code).SETTINGS_LISTEN_VOICES,
                callback_data="voice_messages_setting:listen",
            ),
        ],
        [
            InlineKeyboardButton(
                text=get_localization(language_code).ACTION_BACK,
                callback_data=f"voice_messages_setting:back:{model}"
                if model
                else "voice_messages_setting:back",
            )
        ],
    ]
