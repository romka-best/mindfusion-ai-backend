...
from bot.database.models.common import DeepSeekVersion, Model
    ...
    buttons = [
        [
            InlineKeyboardButton(
                ...
                + (
                    " ✅"
                    if model == Model.DEEP_SEEK and model_version == DeepSeekVersion.V3
                    else ""
                ),
        ...
        [
            InlineKeyboardButton(
                ...
                + (
                    " ✅"
                    if model == Model.DEEP_SEEK and model_version == DeepSeekVersion.R1
                    else ""
                ),
