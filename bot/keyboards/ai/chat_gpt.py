...
from bot.database.models.common import ChatGPTVersion, Model
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(
                ...
                + (
                    " ✅"
                    if model == Model.CHAT_GPT and model_version == ChatGPTVersion.V3_O
                    else ""
                ),
        ...
        [
            InlineKeyboardButton(
                ...
                + (
                    " ✅"
                    if model == Model.CHAT_GPT and model_version == ChatGPTVersion.V4_1
                    else ""
                ),
