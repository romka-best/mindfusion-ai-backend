    ...
    if page == 0:
        if chosen_model == Model.CHAT_GPT:
                    ...
                    [
                        InlineKeyboardButton(
                            ...
                            + (
                                ...
                                and model_version == ChatGPTVersion.V4_Omni_Mini
                                else ""
                            ),
                    ...
                    [
                        InlineKeyboardButton(
                            ...
                            + (
                                " ✅"
                                if model == Model.CHAT_GPT
                                and model_version == ChatGPTVersion.V4_Omni
                                else ""
                            ),
                    ...
                    [
                        InlineKeyboardButton(
                            ...
                            + (
                                " ✅"
                                if model == Model.CHAT_GPT
                                and model_version == ChatGPTVersion.V4_O_Mini
                                else ""
                            ),
                            callback_data=f"model:{Model.CHAT_GPT}:{ChatGPTVersion.V4_O_Mini}",
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            ...
                            + (
                                " ✅"
                                if model == Model.CHAT_GPT
                                and model_version == ChatGPTVersion.V3_O
                                else ""
                            ),
                            callback_data=f"model:{Model.CHAT_GPT}:{ChatGPTVersion.V3_O}",
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            ...
                            + (
                                " ✅"
                                if model == Model.CHAT_GPT
                                and model_version == ChatGPTVersion.V4_1_Mini
                                else ""
                            ),
                            callback_data=f"model:{Model.CHAT_GPT}:{ChatGPTVersion.V4_1_Mini}",
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            ...
                            + (
                                " ✅"
                                if model == Model.CHAT_GPT
                                and model_version == ChatGPTVersion.V4_1
                                else ""
                            ),
                            callback_data=f"model:{Model.CHAT_GPT}:{ChatGPTVersion.V4_1}",
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                ...
                [
                    ...
                    [
                        InlineKeyboardButton(
                            ...
                            + (
                                " ✅"
                                if model == Model.DEEP_SEEK
                                and model_version == DeepSeekVersion.V3
                                else ""
                            ),
                    ...
                    [
                        InlineKeyboardButton(
                            ...
                            + (
                                " ✅"
                                if model == Model.DEEP_SEEK
                                and model_version == DeepSeekVersion.R1
                                else ""
                            ),
            ...
            buttons.extend(
                [
                    ...
                    [
                        InlineKeyboardButton(text="⬅️", callback_data="model:back:4"),
                        InlineKeyboardButton(text="1/5", callback_data="model:page:0"),
                        InlineKeyboardButton(text="➡️", callback_data="model:next:1"),
                    ],
                ]
            )
    elif page == 1:
        buttons.extend(
            [
                ...
                [
                    InlineKeyboardButton(text="⬅️", callback_data="model:back:0"),
                    InlineKeyboardButton(text="2/5", callback_data="model:page:1"),
                    InlineKeyboardButton(text="➡️", callback_data="model:next:2"),
                ],
            ]
        )
    elif page == 2:
                    ...
                    [
                        InlineKeyboardButton(
                            ...
                            + (
                                " ✅"
                                if model == Model.FLUX
                                and model_version == FluxVersion.V1_Dev
                                else ""
                            ),
                    ...
                    [
                        InlineKeyboardButton(
                            ...
                            + (
                                " ✅"
                                if model == Model.FLUX
                                and model_version == FluxVersion.V1_Pro
                                else ""
                            ),
            ...
            [
                ...
                [
                    InlineKeyboardButton(
                        ...
                        + (" ✅" if model == Model.MUSIC_GEN else ""),
                        callback_data=f"model:{Model.MUSIC_GEN}",
                    ),
                    InlineKeyboardButton(
                        text=get_localization(language_code).SUNO
                        + (" ✅" if model == Model.SUNO else ""),
                        callback_data=f"model:{Model.SUNO}",
                    ),
                ],
                [
                    InlineKeyboardButton(text="⬅️", callback_data="model:back:2"),
                    InlineKeyboardButton(text="4/5", callback_data="model:page:3"),
                    InlineKeyboardButton(text="➡️", callback_data="model:next:4"),
                ],
            ]
        )
    elif page == 4:
        buttons.extend(
            [
                ...
                [
                    InlineKeyboardButton(text="⬅️", callback_data="model:back:3"),
                    InlineKeyboardButton(text="5/5", callback_data="model:page:4"),
                    InlineKeyboardButton(text="➡️", callback_data="model:next:0"),
                ],
            ]
        )
...
def build_switched_to_ai_keyboard(
    language_code: LanguageCode, model: Model
) -> InlineKeyboardMarkup:
    buttons = [
        [
            InlineKeyboardButton(
...
def build_switched_to_ai_selection_keyboard(
    language_code: LanguageCode, model: Model
) -> InlineKeyboardMarkup:
    buttons = [
        [
    ...
    buttons.append(
        [
            InlineKeyboardButton(
                ...
                callback_data="switched_to_ai:close",
            )
        ],
    )
...
def build_model_limit_exceeded_keyboard(
    language_code: LanguageCode, had_subscription: bool
) -> InlineKeyboardMarkup:
    buttons = [
        [
            InlineKeyboardButton(
...
def build_model_restricted_keyboard(
    language_code: LanguageCode, had_subscription: bool
) -> InlineKeyboardMarkup:
    buttons = [
        [
...
def build_model_unresolved_request_keyboard(
    language_code: LanguageCode,
) -> InlineKeyboardMarkup:
    buttons = [
        [
