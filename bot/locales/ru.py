...
Ваше изображение {image_width} x {image_height}, соотношение — {actual_ratio}.
Повторите запрос с изображением, у которого ширина/высота в диапазоне между {min_ratio} и {max_ratio}.
"""
