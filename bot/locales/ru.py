...
"""
    ...
    ERROR_DOCUMENT_FORBIDDEN = "⚠️ Я пока работать не умею с такими документами"
...
"""
    ...
    # FaceSwap
    FACE_SWAP_INFO = """
📷 <b>FaceSwap: Выберите один из вариантов</b>

👤 <b>Отправьте фото</b> — заменю лицо на ваше
✍️ <b>Напишите промпт</b> — создам картинку с вашим лицом
Или <b>выберите готовый пакет</b> ниже 👇
"""
...
Или <b>переключите модель</b> нажав кнопку ниже 👇
"""
    FACE_SWAP_MIN_ERROR = """
🤨 <b>Постойте!</b>
...
{Russian.VOICE_MESSAGES}: {'Вкл. ✅' if model_info.get(UserSettings.TURN_ON_VOICE_MESSAGES, False) else 'Выкл. ❌'}"""
            ...
            model_version_info = f'\n🤖 Версия: {model_version}' if model_version else ''
...
У вас осталось только <b>{available_seconds} секунд(-а)</b> в вашем арсенале
...
<b>Введите количество</b>, которое вы хотели бы приобрести
"""
...
<b>Продвинутые</b>:
    ...
    ┣ 🎨 Midjourney 6.1{f': доп. {additional_usage_quota[Quota.MIDJOURNEY]}' if additional_usage_quota[Quota.MIDJOURNEY] > 0 else ''}
...
Эта роль уже с нами! Мы уже имеем <b>такую же звезду</b> в нашем AI-космосе

🤔 Попробуйте придумать другое название, что-то свежее и оригинальное 🚀
"""
...
🤖 Помощник был благородно изменён. Поздравляю, вы только что внесли свой вклад в историю AI-помощников! 🚀
...
🔍 Название пакета уже занято! Имя, которое вы выбрали для нового пакета FaceSwap, уже существует в нашей галерее чудес. Но не переживайте, это всего лишь повод проявить ещё больше креативности!
...
🎨 <b>Время творить! Вы выбрали пакет для редактирования</b>
...
Напиши дату, когда происходили эти транзакции. Формат: "ДД.ММ.ГГГГ". Например, "01.04.2024" или "25.12.2023" 🕰️
"""
