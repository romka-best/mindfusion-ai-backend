...
def get_model_version(model_settings: dict):
    if model_settings[UserSettings.VERSION] == DALLEVersion.V3:
        ...
        model_settings[UserSettings.VERSION] == MidjourneyVersion.V5
        or model_settings[UserSettings.VERSION] == MidjourneyVersion.V6
        or model_settings[UserSettings.VERSION] == MidjourneyVersion.V7
        or model_settings[UserSettings.VERSION] == KlingVersion.V1
        or model_settings[UserSettings.VERSION] == PikaVersion.V2
    ):
